...
func main() {
	...
	binaryPath := fmt.Sprintf("%s%s", os.ExpandEnv("$HOME"), "/Opt/avalanchego/avalanchego")
	// binaryPath := fmt.Sprintf("%s%s", os.ExpandEnv("$GOPATH"), "/src/github.com/ava-labs/avalanchego/build/avalanchego")
